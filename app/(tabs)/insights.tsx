  ...
  return (
    <View className="flex-1 bg-[#09090b] justify-start relative">
      ...
      <View className="px-6 pt-20 pb-4 z-10 bg-transparent flex-row justify-between items-end">
        <View>
          <Text className="text-3xl font-bold text-white tracking-tight">Insights</Text>
          <Text className="text-zinc-400 mt-1 text-[15px] font-medium">Your growth at a glance</Text>
        </View>
      </View>
      ...
      >
        ...
        <View className="flex-row flex-wrap justify-between mb-2">
          ...
          <View className="w-[48%] bg-zinc-900/60 border border-zinc-800 rounded-[28px] p-5 mb-4">
            ...
            <Text className="text-3xl font-semibold text-white tracking-tight">{totalPetals}</Text>
            <Text className="text-zinc-500 text-[11px] font-bold mt-1 uppercase tracking-widest">Total Petals</Text>
          </View>
          ...
          <View className="w-[48%] bg-zinc-900/60 border border-zinc-800 rounded-[28px] p-5 mb-4">
            ...
            <Text className="text-3xl font-semibold text-white tracking-tight">{bestStreak}</Text>
            <Text className="text-zinc-500 text-[11px] font-bold mt-1 uppercase tracking-widest">Best Streak</Text>
          </View>
          ...
          <View className="w-[48%] bg-zinc-900/60 border border-zinc-800 rounded-[28px] p-5 mb-4">
            ...
            <Text className="text-3xl font-semibold text-white tracking-tight">{completionRate}%</Text>
            <Text className="text-zinc-500 text-[11px] font-bold mt-1 uppercase tracking-widest">Today's Rate</Text>
          </View>
          ...
          <View className="w-[48%] bg-zinc-900/60 border border-zinc-800 rounded-[28px] p-5 mb-4">
            ...
            <Text className="text-3xl font-semibold text-white tracking-tight">{totalHabits}</Text>
            <Text className="text-zinc-500 text-[11px] font-bold mt-1 uppercase tracking-widest">Active Habits</Text>
          </View>
        </View>
        ...
        <View className="bg-zinc-900/60 border border-zinc-800 rounded-[28px] p-6 mb-8 mt-2">
          <View className="flex-row justify-between items-center mb-8">
            <Text className="text-white text-lg font-semibold tracking-tight">Last 7 Days</Text>
            <Text className="text-emerald-500 font-bold text-xs bg-emerald-500/10 px-2 py-1 rounded-md">ACTIVITY</Text>
          </View>
            ...
            {weekData.map((data, index) => {
              ...
              return (
                <View key={index} className="items-center w-8">
                  ...
                  <Text className={`text-[13px] font-bold ${isToday ? 'text-emerald-400' : 'text-zinc-600'}`}>
                    {data.dayName}
                  </Text>
                </View>
              );
